...
export default class extends Component {
  ...
  render() {
    ...
    let clearBtn = (Platform.OS === 'android')
    ...
    return (
      <View style={containerStyle}>
        ...
        <TextInput
          {...props}
          style={this.props.shouldEditText ?  inputStyle : inputStyle}
          ...
          value={value}
          clearButtonMode = {clearBtn?'while-editing':'never'}
          keyboardType={this.props.keyboardStyle}
        />
         {this.props.shouldEditText ? <Underline {...underlineProps} /> : <Underline {...underlineProps} />}
